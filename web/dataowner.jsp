...
<%
 if (request.getParameter("msg") != null) {
            ...
            if (request.getParameter("msgr") != null) {
                out.println("<script>alert('Error Occured.Please try again later')</script>");
                                             } 
 if (request.getParameter("msgg") != null) {
            ...
            if (request.getParameter("msgrr") != null) {
                out.println("<script>alert('Login error')</script>");
                                             } 
 %>
<body id="page2">
<div class="body1">
    ...
    <section id="content">
      <div class="box1">
        <div class="wrapper">
          <article class="col1">
            <div class="pad_left1">
              <h2 class="pad_bot1">Login Here</h2>
            </div>
              ...
              <div class="box2">
                <div class="wrapper">
                 ...
                 <article class="col_4 pad_left2">
                  ...
                  <div class="wrapper">
                    <div class="bg">
                        UserName:  <input type="text" name="user" id="user" style="background-color: #ff69b4; height: 30px;"/><br><br>
                    Password:&nbsp;&nbsp;<input type="password" name="pass" id="pass" style="background-color: #ff69b4; height: 30px;">
                    </div>
                  </div>
